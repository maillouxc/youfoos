...
namespace YouFoos.DataAccess.SharedTestUtils.TestData
{
    ...
    {   
        ...
        public static readonly User TestUser_1 = new User("test@gmail.com", "Testy McTestFace", "4630118")
        {
            Id = "546c776b3e23f5f2ebdd3b01",
            JoinedTimestamp = DateTime.UtcNow.AddDays(-1)
        };

        public static readonly User TestUser_2 = new User("test2@gmail.com", "Testy TheSecond", "2345678")
        {
            Id = "446c776b3e23f5f2ebdd3b02",
            JoinedTimestamp = DateTime.UtcNow.AddDays(-2)
        };

        public static readonly User TestUser_3_Anon = new User(null, "Card 56789", "3456789", isUnclaimed: true)
        {
            Id = "446c776b3e23f562ebdd3b03",
            JoinedTimestamp = DateTime.UtcNow.AddDays(-3)
        };

        public static readonly User TestUser_4 = new User("test4@gmail.com", "Johnny Test", "4567890")
        {
